...
def parse_arguments():
    ...
    args.path_out = f'{args.path_out}_cs{args.cell_size}_cd{args.cell_dist}_sc{"Y" if args.shift_cells else "N"}_pd{args.pose_dist}_pc{args.pose_count}_sp{"Y" if args.shift_poses else "N"}_{args.describe_by}'
